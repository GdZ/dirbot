...
class TMALL_NAIFEN_RULES():
    name = "tmall_naiFen"
    allowed_domains = ["tmall.com"]
    start_urls = [
        "https://chaoshi.detail.tmall.com/item.htm?toSite=main&id=522660375657&id=522660375657&spm=a220m.1000858.1000725.15.TTXU9V&cat_id=2&rn=97d74d2c2562462b536535619c916035&standard=1&user_id=725677994&is_b=1"
    ]
    filters = {
        ...
        'body': {'0': '//body', '1':''},
        # root-nav -ok
        'root_nav': {'0':'//ul[contains(@class, "nav ")]/li/text()', '1':''},
        # 'root_nav': {'0':'//ul[contains(@class, "nav J_MallCrumbs")]/li/text()', '1':''},
