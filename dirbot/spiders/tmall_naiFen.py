...
from dirbot.spiders.model.tmall_com.naiFen.rules import TMALL_NAIFEN_RULES


class jdSpider(Spider):
    rules = TMALL_NAIFEN_RULES()
    name = rules.name
    ...
    def parse(self, response):
        ...
        for body in bodies:
            ...
            # jd_root_nav
            item['tmall_naifen_root_nav'] = body.xpath(self.rules.filters['root_nav']['0']).extract()
