...
class jdxiangziSpider(Spider):
    ...
    def parse(self, response):
        ...
        for body in bodies:
            ...
            # jd_root_nav
            item['jdxiangzi_root_nav'] = body.xpath(self.rules.filters['root_nav']['0']).extract()
            ...
            item['jdxiangzi_spec_n1'] = body.xpath(self.rules.filters['spec_n1']['0']).extract()
            ## this rules'jd_p_ad' is right, but cannot select. I don't know why
            item['jdxiangzi_p_ad'] = body.xpath(self.rules.filters['p_ad']['0']).extract()

            ## this rules'jd_jd_price' is right, but cannot select. I don't know why
            item['jdxiangzi_jd_price'] = body.xpath(self.rules.filters['jd_price']['0']).extract()
            ...
            item['jdxiangzi_canshu'] = body.xpath(self.rules.filters['canshu']['0']).extract()
